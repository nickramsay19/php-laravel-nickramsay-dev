<x-layout title="Nicholas Ramsay">
    ...
    <p class="my-1">I will be completing my Bachelor of Software Engineering at the University of New South Wales in 2024.</p>

    <section class="mt-2">
        <x-link to="posts" class="text-lg font-mono underline">Posts</x-link>
        <x-posts.list :posts="$posts->take(3)" :show-admin-options="false" />
    </section>
</x-layout>